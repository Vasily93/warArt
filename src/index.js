...
const images = [
  {position: [-5, 0, 1.5], rotation: [0, 0, 0], url: [img1, img1bw] , name: 'DANCE OF BIRTH AND DEATH', description: text},
  {position: [1, 0, 1.5], rotation: [0, 0, 0], url: [img2, img2BW] , name: 'IMAGE 2', description: text},
  {position: [4, 0, 1.5], rotation: [0, 0, 0], url: [img3, img3BW] , name: 'IMAGE 3', description: text},
  {position: [-2, 0, 1.5], rotation: [0, 0, 0], url: [img4, img4BW] , name: 'IMAGE 4', description: text},
  // {position: [1, 0, 1.5], rotation: [0, 0, 0], url: [img1, img5BW] , name: 'DANCE OF BIRTH AND DEATH', description: text},
  // {position: [1, 0, 1.5], rotation: [0, 0, 0], url: [img1, img6BW] , name: 'DANCE OF BIRTH AND DEATH', description: text},
